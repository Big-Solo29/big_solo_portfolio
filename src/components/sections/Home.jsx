    ...
    <section id='home' className='min-h-screen flex items-center justify-center relative'>
        ...
        <div className='text-center z-10 px-4'>
            ...
            <div className='flex justify-center space-x-4'>
                <a href="#projects" className='bg-blue-500 text-white bg-gradient-to-r from-blue-500 to-purple-600 py-3 px-6  rounded font-medium transition relative overflow-hidden hover:translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)'>View Project</a>
