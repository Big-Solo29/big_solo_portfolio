...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div className='p-6 rounded-xl border border-white/10 hover:translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition '>
        ...
        <p className='text-gray-400 mb-4'>
            Well Responsive Rocket App built in better interactions for users. 
        </p>
        <div>
    ...
    <div className='p-6 rounded-xl border border-white/10 hover:translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition '>
        <h3 className='text-xl font-bold mb-2'>Quickstay</h3>
        <p className='text-gray-400 mb-4'>
            A Hotel Booking Website with a friendly built interactions.
        </p>
        <div>
            {["HTML","Tailwindcss", "JavaScript" ].map((tech, key) => (
                <span 
        ...
        <div className='flex justify-between items-center'>
            <a href="https://quickstayhotel-blush.vercel.app/" className='text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600 hover:text-blue-500 transition-colors my-4'>View Project →</a>
        </div>
    </div>
</div>
        </div>
